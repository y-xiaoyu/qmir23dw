...
#data('./data_raw/df_learnr14.rda')
#getwd()
#load("C:/Users/dweyrauc/Documents/Arbeit/Teaching/2022_FSS_QMIR/learnr/qmir22dw/data_raw/df_learnr14.rda")
df_ci <- df_learnr14
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url ="https://ilias.uni-mannheim.de/goto.php?target=svy_1239772&client_id=ILIAS"))
```